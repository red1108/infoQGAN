...
generator = Generator.LinearGenerator(input_dim=SEED_DIM, output_dim=2, hidden_size=hidden_dim)
# 판별자, MINE 초기화
...
base_name = f'{use_mine}_sd{SEED_DIM}_hd{hidden_dim}_{data_type}_{current_time}'
